...
trait StringInstances {
  implicit object stringInstance extends Monoid[String] with Show[String] with Equal[String] with Order[String] with NaturalHashable[String] with IsEmpty[({ type λ[α] = String })#λ] {
    type SA[α] = String
